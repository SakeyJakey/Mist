...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdateWalkingPlayer()
    {
        ...
        EventMotion e = new EventMotion(EventType.PRE, posX, getEntityBoundingBox().minY, posZ, rotationYaw, rotationPitch, onGround);

        if(!Mist.instance.destructed)
            Mist.instance.getEventManager().handleEvent(e);
        ...
        if (this.isCurrentViewEntity())
        {
            ...
            double d4 = (double)(e.getYaw() - this.lastReportedPitch);
