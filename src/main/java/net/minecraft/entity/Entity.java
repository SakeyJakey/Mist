...
import dev.sakey.mist.modules.impl.movement.SafeWalk;
import dev.sakey.mist.modules.impl.player.Scaffold;
...
//                    (this.isSneaking() ||
//                            (Mist.instance.getModuleManager().getModule(Scaffold.class).isEnabled() && Scaffold.safewalk.isEnabled()) ||
//                                Mist.instance.getModuleManager().getModule(SafeWalk.class).isEnabled());
