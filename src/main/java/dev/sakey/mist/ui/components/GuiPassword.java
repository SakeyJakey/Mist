...
public class GuiPassword extends Gui {
	...
	public GuiPassword(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height) {
		this.id = componentId;
	...
	public void drawTextBox() {
		if (this.getVisible()) {
			...
			if (s.length() > 0) {
				...
				j1 = this.fontRendererInstance.drawStringWithShadow(censoredString, (float) l, (float) i1, i);
			}
