...
import dev.sakey.mist.utils.client.openauth.model.request.*;
...
public class Authenticator {
	 ...
	 */
	private String sendPostRequest(String url, String json) throws AuthenticationException, IOException, URISyntaxException {
		byte[] jsonBytes = json.getBytes(StandardCharsets.UTF_8);
		URL serverURL = new URI(url).toURL();
